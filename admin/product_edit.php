              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-conrol" name="quantity" value="<?php echo $result[0]['quantity']?>">
                    </div>
                    <div class="form-group">
                        <label for="">Price</label><p style="color:red"><?php echo empty($priceError)  ? '':'*'.$priceError; ?></p>
                          <input type="number" class="form-conrol" name="price" value="<?php echo $result[0]['price']?>">
                    </div>
                    <div class="form-group">
                        <label for="">Image</label><p style="color:red"><?php echo empty($imgError)  ? '':'*'.$imgError; ?></p>
                        <img src="images/<?php echo $result[0]['image']?>" alt="" width="150" height="150">
